...
QT_MOC_LITERAL(1, 10, 19), // "PlayerReachedFinish"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 20) // "GenerateNewMazeLevel"

    },
    "GameBoard\0PlayerReachedFinish\0\0"
...
void GameBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->PlayerReachedFinish(); break;
        case 1: _t->GenerateNewMazeLevel(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameBoard::PlayerReachedFinish)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameBoard::PlayerReachedFinish()
{
